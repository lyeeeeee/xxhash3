...
func xxh3HashLarge(xinput unsafe.Pointer, l int) (acc uint64) {
	...
	if length <= 128 {
		...
		acc += mix(unalign.Read8(xinput, 16*0)^xsecret_000, unalign.Read8(xinput, 16*0+8)^xsecret_008)
		acc += mix(unalign.Read8(xinput, 16*1)^xsecret_016, unalign.Read8(xinput, 16*1+8)^xsecret_024)
		acc += mix(unalign.Read8(xinput, 16*2)^xsecret_032, unalign.Read8(xinput, 16*2+8)^xsecret_040)
		acc += mix(unalign.Read8(xinput, 16*3)^xsecret_048, unalign.Read8(xinput, 16*3+8)^xsecret_056)
		acc += mix(unalign.Read8(xinput, 16*4)^xsecret_064, unalign.Read8(xinput, 16*4+8)^xsecret_072)
		acc += mix(unalign.Read8(xinput, 16*5)^xsecret_080, unalign.Read8(xinput, 16*5+8)^xsecret_088)
		acc += mix(unalign.Read8(xinput, 16*6)^xsecret_096, unalign.Read8(xinput, 16*6+8)^xsecret_104)
		acc += mix(unalign.Read8(xinput, 16*7)^xsecret_112, unalign.Read8(xinput, 16*7+8)^xsecret_120)

		acc = xxh3Avalanche(acc)
		nbRounds := length >> 4 << 4

		for i := uint64(8 * 16); i < nbRounds; i += 16 {
			acc += mix(unalign.Read8(xinput, uintptr(i))^unalign.Read8(xsecret, uintptr(i-125)), unalign.Read8(xinput, uintptr(i+8))^unalign.Read8(xsecret, uintptr(i-117)))
		}
